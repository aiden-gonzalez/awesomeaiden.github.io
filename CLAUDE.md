...
- **First person for authorship, not runtime behavior.** "I designed", "I built in logic to collapse..." are right. "I collapse nested adds" is wrong, the code does that, not Aiden.
